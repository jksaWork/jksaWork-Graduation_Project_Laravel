...
<html lang="en">
	...
	<head><base href="">
		...
		<link rel="shortcut icon" href="{{ asset('assets/media/logos/favicon.icon') }}" />
		<!--begin::Fonts-->
										...
										<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61b9bf3a9d1a3">
											...
											<div class="px-7 py-5">
												...
												<div class="mb-10">
													...
													<!--begin::Input-->
													<div>
														<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61b9bf3a9d1a3" data-allow-clear="true">
															<option></option>
